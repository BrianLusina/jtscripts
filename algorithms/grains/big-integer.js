var bigInt = (function (e) {
  'use strict'; function o (e, t) {
    ...
    c(e); const n = e.length; if (n < 4 && A(e, i) < 0) {
      switch (n) { case 0:return 0; case 1:return e[0]; case 2:return e[0] + e[1] * t; default:return e[0] + (e[1] + e[2] * t) * t }
    } return e
  } function c (e) {
    let t = e.length; while (e[--t] === 0) {
    ...
    let r, i; return A(e, t) >= 0 ? r = g(e, t) : (r = g(t, e), n = !n), r = l(r), typeof r === 'number' ? (n && (r = -r), new u(r)) : new o(r, n)
  } function b (e, n, r) {
    const i = e.length
    let s = new Array(i)
    let a = -n
    const f = t
    let c; let h; for (c = 0; c < i; c++) {
    ...
    const o = h(s)
    const u = t
    let a; let f; let l; let p; let d; for (l = 0; l < r; ++l) {
      p = e[l]; for (let v = 0; v < i; ++v) {
        d = n[v], a = p * d + o[l + v], f = Math.floor(a / u), o[l + v] = a - f * u, o[l + v + 1] += f
      }
    } return c(o), o
  } function E (e, n) {
    const r = e.length
    ...
    let n = Math.max(e.length, t.length); if (n <= 400) {
      return w(e, t)
    } n = Math.ceil(n / 2); const r = e.slice(n)
    const i = e.slice(0, n)
    const s = t.slice(n)
    const o = t.slice(0, n)
    const u = x(i, o)
    const a = x(r, s)
    const f = x(v(i, r), v(o, s)); return v(v(u, S(g(g(f, u), a), n)), S(a, 2 * n))
  } function T (e) {
    const n = e.length
    const r = h(n + n)
    const i = t
    let s; let o; let u; let a; let f; for (u = 0; u < n; u++) {
      a = e[u]; for (let l = 0; l < n; l++) {
        f = e[l], s = a * f + r[u + l], o = Math.floor(s / i), r[u + l] = s - o * i, r[u + l + 1] += o
      }
    } return c(r), r
  } function N (e, n) {
    const r = e.length
    ...
    let f = E(e, a)
    const c = E(n, a)
    let p; let d; let v; let m; let g; let y; let b; f.length <= r && f.push(0), c.push(0), u = c[i - 1]; for (d = r - i; d >= 0; d--) {
      p = s - 1, p = Math.floor((f[d + i] * s + f[d + i - 1]) / u), v = 0, m = 0, y = c.length; for (g = 0; g < y; g++) {
        v += p * c[g], b = Math.floor(v / s), m += f[d + g] - (v - b * s), v = b, m < 0 ? (f[d + g] = m + s, m = -1) : (f[d + g] = m, m = 0)
      } while (m !== 0) {
        p -= 1, v = 0; for (g = 0; g < y; g++) {
          v += f[d + g] - s + c[g], v < 0 ? (f[d + g] = v + s, v = 0) : (f[d + g] = v, v = 1)
        } m += v
      }o[d] = p
    ...
    let o = []
    const u = t
    let a; let f; let c; let h; let p; while (r) {
      o.unshift(e[--r]); if (A(o, n) < 0) {
        s.push(0); continue
    ...
    const i = h(r)
    const s = t
    let o; let u; let a; let f; a = 0; for (o = r - 1; o >= 0; --o) {
    ...
    let c; if (a === 0) {
      ...
      if (a === 1) {
        ...
        return [e.negate(), W[0]]
      } const h = Math.abs(a); if (h < t) {
        r = k(s, h), c = l(r[0]); let d = r[1]; return e.sign && (d = -d), typeof c === 'number' ? (e.sign !== i.sign && (c = -c), [new u(c), new u(d)]) : [new o(c, e.sign !== i.sign), new u(d)]
      }a = f(h)
    } const v = A(s, a); if (v === -1) {
      return [W[0], e]
    } if (v === 0) {
      return [W[e.sign === i.sign ? 1 : -1], W[0]]
    } s.length + a.length <= 200 ? r = N(s, a) : r = C(s, a), c = r[0]; const m = e.sign !== i.sign
    let g = r[1]
    const y = e.sign; return typeof c === 'number' ? (m && (c = -c), c = new u(c)) : c = new o(c, m), typeof g === 'number' ? (y && (g = -g), g = new u(g)) : g = new o(g, y), [c, g]
  } function A (e, t) {
    ...
    return (typeof e === 'number' || typeof e === 'string') && Number(Math.abs(e)) <= t || e instanceof o && e.value.length <= 1
  } function P (e, t, n) {
    t = z(t); const r = e.isNegative()
    ...
    let f = !1
    let l = !1; while (!f || !l) {
      s.isZero() ? (f = !0, u.push(r ? 1 : 0)) : r ? u.push(s.isEven() ? 1 : 0) : u.push(s.isEven() ? 0 : 1), o.isZero() ? (l = !0, a.push(i ? 1 : 0)) : i ? a.push(o.isEven() ? 1 : 0) : a.push(o.isEven() ? 0 : 1), s = s.over(2), o = o.over(2)
    } const c = []; for (let h = 0; h < u.length; h++) {
      c.push(n(u[h], a[h]))
    } let p = bigInt(c.pop()).negate().times(bigInt(2).pow(c.length)); while (c.length) {
    ...
    e = z(e), n = z(n); const r = B(e, n)
    const i = H(e, n)
    const s = i.subtract(r); if (s.isSmall) {
      return r.add(Math.random() * s)
    } const u = s.value.length - 1
    let a = []
    let f = !0; for (let c = u; c >= 0; c--) {
      const h = f ? s.value[c] : t
      const d = p(Math.random() * h); a.unshift(d), d < h && (f = !1)
    } return a = l(a), r.add(new o(a, !1, typeof a === 'number'))
  } function R (e) {
    let t = e.value; return typeof t === 'number' && (t = [t]), t.length === 1 && t[0] <= 36 ? '0123456789abcdefghijklmnopqrstuvwxyz'.charAt(t[0]) : '<' + t + '>'
  } function U (e, t) {
    t = bigInt(t); if (t.isZero()) {
      ...
      return e.isZero() ? '0' : e.isNegative() ? (new Array(1 - e)).join('10') : '1' + (new Array(Number(e))).join('01')
    } let n = ''; e.isNegative() && t.isPositive() && (n = '-', e = e.abs()); if (t.equals(1)) {
      return e.isZero() ? '0' : n + (new Array(Number(e) + 1)).join(1)
    } const r = []
    let i = e
    let s; while (i.isNegative() || i.compareAbs(t) >= 0) {
      s = i.divmod(t), i = s.quotient; let o = s.remainder; o.isNegative() && (o = t.minus(o).abs(), i = i.next()), r.push(R(o))
    ...
    if (e instanceof o || e instanceof u) {
      ...
      if (a(Number(e))) {
        ...
        const l = f.indexOf('.'); l >= 0 && (s -= f.length - l, f = f.slice(0, l) + f.slice(l + 1)); if (s < 0) {
          throw new Error('Cannot include negative exponent part for integers')
        } f += (new Array(s + 1)).join('0'), e = f
      } const h = /^([0-9][0-9]*)$/.test(e); if (!h) {
  ...
  var i = f(r)
  const s = Math.log(r); o.prototype.add = function (e) {
    let t
    const n = z(e); if (this.sign !== n.sign) {
      return this.subtract(n.negate())
    } const r = this.value
    const i = n.value; return n.isSmall ? new o(m(r, Math.abs(i)), this.sign) : new o(v(r, i), this.sign)
  }, o.prototype.plus = o.prototype.add, u.prototype.add = function (e) {
    const t = z(e)
    const n = this.value; if (n < 0 !== t.sign) {
      return this.subtract(t.negate())
    } let r = t.value; if (t.isSmall) {
      if (a(n + r)) {
        return new u(n + r)
      } r = f(Math.abs(r))
    } return new o(m(r, Math.abs(n)), n < 0)
  }, u.prototype.plus = u.prototype.add, o.prototype.subtract = function (e) {
    const t = z(e); if (this.sign !== t.sign) {
      return this.add(t.negate())
    } const n = this.value
    const r = t.value; return t.isSmall ? b(n, Math.abs(r), this.sign) : y(n, r, this.sign)
  }, o.prototype.minus = o.prototype.subtract, u.prototype.subtract = function (e) {
    const t = z(e)
    const n = this.value; if (n < 0 !== t.sign) {
      return this.add(t.negate())
    } const r = t.value; return t.isSmall ? new u(n - r) : b(r, Math.abs(n), n >= 0)
    ...
    const e = this.sign
    const t = new u(-this.value); return t.sign = !e, t
    ...
    } const s = Math.abs(r); return s < t ? new o(E(i, s), this.sign !== n.sign) : new o(w(i, f(s)), this.sign !== n.sign)
  }, u.prototype.times = u.prototype.multiply, o.prototype.square = function () {
    return new o(T(this.value), !1)
  }, u.prototype.square = function () {
    const e = this.value * this.value; return a(e) ? new u(e) : new o(T(f(Math.abs(this.value))), !1)
  }, o.prototype.divmod = function (e) {
    const t = L(this, e); return { quotient: t[0], remainder: t[1] }
    ...
    let i; let s; let o; if (r === 0) {
      ...
      r & !0 && (o = o.times(s), --r); if (r === 0) {
        break
      } r /= 2, s = s.square()
    } return o
  }, u.prototype.pow = o.prototype.pow, o.prototype.modPow = function (e, t) {
    e = z(e), t = z(t); if (t.isZero()) {
      throw new Error('Cannot take modPow with modulus 0')
    } let n = W[1]
    let r = this.mod(t); if (r.isZero()) {
      return W[0]
    } while (e.isPositive()) {
    ...
    const t = z(e)
    const n = this.value
    const r = t.value; return t.isSmall ? 1 : A(n, r)
  }, u.prototype.compareAbs = function (e) {
    const t = z(e)
    const n = Math.abs(this.value)
    let r = t.value; return t.isSmall ? (r = Math.abs(r), n === r ? 0 : n > r ? 1 : -1) : -1
  }, o.prototype.compare = function (e) {
    const t = z(e)
    const n = this.value
    const r = t.value; return this.sign !== t.sign ? t.sign ? 1 : -1 : t.isSmall ? this.sign ? -1 : 1 : A(n, r) * (this.sign ? -1 : 1)
  }, o.prototype.compareTo = o.prototype.compare, u.prototype.compare = function (e) {
    const t = z(e)
    const n = this.value
    const r = t.value; return t.isSmall ? n === r ? 0 : n > r ? 1 : -1 : n < 0 !== t.sign ? n < 0 ? -1 : 1 : n < 0 ? 1 : -1
    ...
    const t = z(e)
    const n = t.value; return n === 0 ? !1 : n === 1 ? !0 : n === 2 ? this.isEven() : this.mod(t).equals(W[0])
  }, u.prototype.isDivisibleBy = o.prototype.isDivisibleBy, o.prototype.isPrime = function () {
    const e = this.abs()
    const t = e.prev(); if (e.isUntest()) {
      return !1
    ...
    let r = t
    let i; let s; let o; let u; while (r.isEven()) {
      r = r.divide(2)
    } for (o = 0; o < n.length; o++) {
      u = bigInt(n[o]).modPow(r, e); if (u.equals(W[1]) || u.equals(t)) {
        continue
    ...
    const e = this.value; return this.sign ? b(e, 1, this.sign) : new o(m(e, 1), this.sign)
  }, u.prototype.next = function () {
    const e = this.value; return e + 1 < r ? new u(e + 1) : new o(i, !1)
  }, o.prototype.prev = function () {
    const e = this.value; return this.sign ? new o(m(e, 1), !0) : b(e, 1, this.sign)
  }, u.prototype.prev = function () {
    const e = this.value; return e - 1 > -r ? new u(e - 1) : new o(i, !0)
  }; const O = [1]; while (O[O.length - 1] <= t) {
    O.push(2 * O[O.length - 1])
  } const M = O.length
  const _ = O[M - 1]; o.prototype.shiftLeft = function (e) {
    if (!D(e)) {
      return e.isNegative() ? this.shiftRight(e.abs()) : this.times(W[2].pow(e))
    } e = Number(e); if (e < 0) {
      return this.shiftRight(-e)
    } let t = this; while (e >= M) {
      t = t.multiply(_), e -= M - 1
    } return t.multiply(O[e])
  }, u.prototype.shiftLeft = o.prototype.shiftLeft, o.prototype.shiftRight = function (e) {
    let t; if (!D(e)) {
      return e.isNegative() ? this.shiftLeft(e.abs()) : (t = this.divmod(W[2].pow(e)), t.remainder.isNegative() ? t.quotient.prev() : t.quotient)
    } e = Number(e); if (e < 0) {
      return this.shiftLeft(-e)
    } let n = this; while (e >= M) {
      if (n.isZero()) {
        return n
  ...
  }, u.prototype.xor = o.prototype.xor; const q = function (e, t) {
    let n = W[0]
    let r = W[1]
    const i = e.length; if (t >= 2 && t <= 36 && i <= s / Math.log(t)) {
      return new u(parseInt(e, t))
    } t = z(t); const o = []
    let a
    const f = e[0] === '-'; for (a = f ? 1 : 0; a < e.length; a++) {
      const l = e[a].toLowerCase()
      const c = l.charCodeAt(0); if (c >= 48 && c <= 57) {
        o.push(z(l))
      } else if (c >= 97 && c <= 122) {
        ...
        if (l !== '<') {
          ...
          a++
        } while (e[a] !== '>'); o.push(z(e.slice(h + 1, a)))
      }
    }o.reverse(); for (a = 0; a < o.length; a++) {
    ...
    return this.value
  }, u.prototype.toJSNumber = u.prototype.valueOf; var W = function (e, t) {
    return typeof e === 'undefined' ? W[0] : typeof t !== 'undefined' ? Number(t) === 10 ? z(e) : q(e, t) : z(e)
  }; for (let X = 0; X < 1e3; X++) {
