var bigInt = (function (e) {
	...
	var r, i; return A(e, t) >= 0 ? r = g(e, t) : (r = g(t, e), n = !n), r = l(r), typeof r === 'number' ? (n && (r = -r), new u(r)) : new o(r, n);
} function b(e, n, r) {
	var i = e.length,
		s = new Array(i),
		a = -n,
	...
	var r = e.length,
		...
		o = h(s),
		u = t,
		a, f, l, p, d; for (l = 0; l < r; ++l) {
			p = e[l]; for (var v = 0; v < i; ++v) {
	...
	var n = Math.max(e.length, t.length); if (n <= 400) {
		return w(e, t);
	} n = Math.ceil(n / 2); var r = e.slice(n),
		i = e.slice(0, n),
		s = t.slice(n),
		o = t.slice(0, n),
		u = x(i, o),
	...
	var n = e.length,
		r = h(n + n),
		i = t,
		s, o, u, a, f; for (u = 0; u < n; u++) {
			a = e[u]; for (var l = 0; l < n; l++) {
	...
	var r = e.length,
		...
		f = E(e, a),
		c = E(n, a),
		p, d, v, m, g, y, b; f.length <= r && f.push(0), c.push(0), u = c[i - 1]; for (d = r - i; d >= 0; d--) {
	...
	var r,
		...
		c; if (a === 0) {
			...
			if (a === 1) {
				...
				return [e.negate(), W[0]];
			} var h = Math.abs(a); if (h < t) {
				r = k(s, h), c = l(r[0]); var d = r[1]; return e.sign && (d = -d), typeof c === 'number' ? (e.sign !== i.sign && (c = -c), [new u(c), new u(d)]) : [new o(c, e.sign !== i.sign), new u(d)];
			}a = f(h);
		} var v = A(s, a); if (v === -1) {
			return [W[0], e];
		} if (v === 0) {
			return [W[e.sign === i.sign ? 1 : -1], W[0]];
		} s.length + a.length <= 200 ? r = N(s, a) : r = C(s, a), c = r[0]; var m = e.sign !== i.sign,
			g = r[1],
	...
	t = z(t); var r = e.isNegative(),
		...
		} var c = []; for (var h = 0; h < u.length; h++) {
			c.push(n(u[h], a[h]));
		} var p = bigInt(c.pop()).negate().times(bigInt(2).pow(c.length)); while (c.length) {
	...
	e = z(e), n = z(n); var r = B(e, n),
		i = H(e, n),
		s = i.subtract(r); if (s.isSmall) {
			return r.add(Math.random() * s);
		} var u = s.value.length - 1,
			a = [],
			f = !0; for (var c = u; c >= 0; c--) {
				var h = f ? s.value[c] : t,
					d = p(Math.random() * h); a.unshift(d), d < h && (f = !1);
			} return a = l(a), r.add(new o(a, !1, typeof a === 'number'));
} function R(e) {
	var t = e.value; return typeof t === 'number' && (t = [t]), t.length === 1 && t[0] <= 36 ? '0123456789abcdefghijklmnopqrstuvwxyz'.charAt(t[0]) : '<' + t + '>';
} function U(e, t) {
	...
	} var n = ''; e.isNegative() && t.isPositive() && (n = '-', e = e.abs()); if (t.equals(1)) {
		return e.isZero() ? '0' : n + (new Array(Number(e) + 1)).join(1);
	} var r = [],
		i = e,
		s; while (i.isNegative() || i.compareAbs(t) >= 0) {
			s = i.divmod(t), i = s.quotient; var o = s.remainder; o.isNegative() && (o = t.minus(o).abs(), i = i.next()), r.push(R(o));
	...
	if (e instanceof o || e instanceof u) {
		...
		if (a(Number(e))) {
			...
			throw new Error('Invalid integer: ' + s + ' is not a valid exponent.');
				...
				l = f.indexOf('.'); l >= 0 && (s -= f.length - l, f = f.slice(0, l) + f.slice(l + 1)); if (s < 0) {
				throw new Error('Cannot include negative exponent part for integers');
			} f += (new Array(s + 1)).join('0'), e = f;
		} var h = /^([0-9][0-9]*)$/.test(e); if (!h) {
	...
	s = Math.log(r); o.prototype.add = function (e) {
		...
		var t = z(e),
			n = this.value; if (n < 0 !== t.sign) {
				return this.add(t.negate());
			} var r = t.value; return t.isSmall ? new u(n - r) : b(r, Math.abs(n), n >= 0);
	...
	var n = z(e),
		...
		} var s = Math.abs(r); return s < t ? new o(E(i, s), this.sign !== n.sign) : new o(w(i, f(s)), this.sign !== n.sign);
}, u.prototype.times = u.prototype.multiply, o.prototype.square = function () {
	return new o(T(this.value), !1);
}, u.prototype.square = function () {
	var e = this.value * this.value; return a(e) ? new u(e) : new o(T(f(Math.abs(this.value))), !1);
}, o.prototype.divmod = function (e) {
	var t = L(this, e); return {quotient: t[0], remainder: t[1]};
	...
	var t = z(e),
		n = this.value,
		r = t.value; return t.isSmall ? 1 : A(n, r);
	...
	var t = z(e),
		n = this.value,
		r = t.value; return this.sign !== t.sign ? t.sign ? 1 : -1 : t.isSmall ? this.sign ? -1 : 1 : A(n, r) * (this.sign ? -1 : 1);
...
}; var O = [1]; while (O[O.length - 1] <= t) {
	O.push(2 * O[O.length - 1]);
} var M = O.length,
	_ = O[M - 1]; o.prototype.shiftLeft = function (e) {
		if (!D(e)) {
			return e.isNegative() ? this.shiftRight(e.abs()) : this.times(W[2].pow(e));
		} e = Number(e); if (e < 0) {
			return this.shiftRight(-e);
		} var t = this; while (e >= M) {
	...
	}, u.prototype.xor = o.prototype.xor; var q = function (e, t) {
	var n = W[0],
		r = W[1],
		i = e.length; if (t >= 2 && t <= 36 && i <= s / Math.log(t)) {
			return new u(parseInt(e, t));
		} t = z(t); var o = [],
			a,
			f = e[0] === '-'; for (a = f ? 1 : 0; a < e.length; a++) {
				var l = e[a].toLowerCase(),
					c = l.charCodeAt(0); if (c >= 48 && c <= 57) {
						o.push(z(l));
					} else if (c >= 97 && c <= 122) {
